...
class Message(ABC):
    ...
    def __init__(self, origin: str, destination: str, type: MessageType) -> None:
        self.origin = origin
    ...
    def to_json(self) -> str:
        mapped_message = {Message.ATTR_MAP[attr]: Message.get_value(obj) for attr, obj in vars(self).items()}
