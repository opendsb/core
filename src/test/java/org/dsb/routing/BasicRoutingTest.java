...
public class BasicRoutingTest {
	...
	public void testSimpleRouting() throws Exception {
		...
		String id = "Local";
		Subscription sub1 = client.subscribe(id, m -> System.out.println("Message received\n  Receptor 'Local'\n  messageId'" + m.getMessageId() + "'"));
		id = "Brasil";
		Subscription sub2 = client.subscribe(id, m -> System.out.println("Message received\n  Receptor 'Brasil'\n  messageId'" + m.getMessageId() + "'"));
		id = "Argentina";
		Subscription sub3 = client.subscribe(id, m -> System.out.println("Message received\n  Receptor 'Argentina'\n  messageId'" + m.getMessageId() + "'"));
		id = "RJ";
		Subscription sub4 = client.subscribe(id, m -> System.out.println("Message received\n  Receptor 'RJ'\n  messageId'" + m.getMessageId() + "'"));
		id = "SP";
		Subscription sub5 = client.subscribe(id, m -> System.out.println("Message received\n  Receptor 'SP'\n  messageId'" + m.getMessageId() + "'"));
	...
	public void testSubscriptions() throws Exception {
		...
		Subscription sub1 = client.subscribe(topic, m -> System.out.println("Message received\n  Receptor '" + topic + "'\n  messageId'" + m.getMessageId() + "'"));
		
		String topic2 = "Brasil/RJ/Politica";
		Subscription sub2 = client.subscribe(topic2, m -> System.out.println("Message received\n  Receptor '" + topic2 + "'\n  messageId'" + m.getMessageId() + "'"));
